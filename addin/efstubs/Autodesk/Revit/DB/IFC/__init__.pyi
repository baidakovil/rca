...
class IFCImportOptions:
    ...
    @property
    def LinkOrientation(self) -> IFCLinkOrientation: ...
    @LinkOrientation.setter
    def LinkOrientation(self, LinkOrientation: IFCLinkOrientation) -> None: ...
    @property
    def LinkPosition(self) -> IFCLinkPosition: ...
    @LinkPosition.setter
    def LinkPosition(self, LinkPosition: IFCLinkPosition) -> None: ...
    @property
