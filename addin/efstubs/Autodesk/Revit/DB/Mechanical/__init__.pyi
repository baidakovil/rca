...
class SystemZoneElementType(ElementType):
    ...
    @UseHumidificationSetPoint.setter
    def UseHumidificationSetPoint(self, value: bool) -> None: ...
    @property
    def UseDehumidificationSetPoint(self) -> bool: ...
    @UseDehumidificationSetPoint.setter
    def UseDehumidificationSetPoint(self, value: bool) -> None: ...
    @property
    def HumidificationSetPoint(self) -> float: ...
    @HumidificationSetPoint.setter
