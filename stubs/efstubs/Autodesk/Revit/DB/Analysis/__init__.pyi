...
class EnergyAnalysisZone(Element):
    ...
    @property
    def UseHumidificationSetPoint(self) -> bool: ...
    @property
    def UseDehumidificationSetPoint(self) -> bool: ...
    @property
    def HumidificationSetPoint(self) -> float: ...
    @property
    def DehumidificationSetPoint(self) -> float: ...
...
class GenericZone(Element):
    @property
    def GeometricDefinition(self) -> ZoneGeometricDefinition: ...
    @property
    ...
    def Area(self) -> float: ...
    @property
    def OccupiedArea(self) -> float: ...
    @property
    def Volume(self) -> float: ...
    @property
    def OccupiedVolume(self) -> float: ...
    @property
    ...
    def CreateSketchBased(doc: Document, typeId: ElementId, name: str, domainData: GenericZoneDomainData, levelId: ElementId, curveLoops: List[CurveLoop]) -> GenericZone: ...
...
class MEPAnalyticalSegment:
    ...
    @property
    def OverrideType(self) -> SegmentOverrideType: ...
    @property
    def Area(self) -> float: ...
    @property
    def IsValidObject(self) -> bool: ...
    def GetNetworkSegmentId(self) -> MEPNetworkSegmentId: ...
    def GetFlowConvergenceCharacteristic(self, doc: Document) -> Tuple[FlowConvergenceCharacteristic, FlowPositionCharacteristic]: ...
