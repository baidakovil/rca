...
class RebarFreeFormCreationResult:
    @property
    def Error(self) -> RebarFreeFormValidationResult: ...
    @property
...
class Rebar(Element):
    @property
    def FreeFormAlignedServerGuid() -> Guid: ...
    @property
    def FreeFormSurfaceServerGuid() -> Guid: ...
    @property
    ...
    @overload
    def CreateFreeForm(doc: Document, barType: RebarBarType, host: Element, curves: List[CurveLoop], style: RebarStyle) -> RebarFreeFormCreationResult: ...
    @overload
    ...
    @overload
    def CreateFreeForm(doc: Document, barType: RebarBarType, host: Element, curves: List[Curve], style: RebarStyle) -> RebarFreeFormCreationResult: ...
    @overload
    ...
    @overload
    def CreateFromCurves(doc: Document, style: RebarStyle, barType: RebarBarType, host: Element, norm: XYZ, curves: List[Curve], barTerminationsData: BarTerminationsData, useExistingShapeIfPossible: bool, createNewShape: bool) -> Rebar: ...
    @overload
    def CreateFromCurves(doc: Document, style: RebarStyle, barType: RebarBarType, startHook: RebarHookType, endHook: RebarHookType, host: Element, norm: XYZ, curves: List[Curve], startHookOrient: RebarHookOrientation, endHookOrient: RebarHookOrientation, terminationRotationAngleAtStart: float, terminationRotationAngleAtEnd: float, endTreatmentTypeIdAtStart: ElementId, endTreatmentTypeIdAtEnd: ElementId, useExistingShapeIfPossible: bool, createNewShape: bool) -> Rebar: ...
    @overload
    ...
    @overload
    def CreateFromCurvesAndShape(doc: Document, rebarShape: RebarShape, barType: RebarBarType, host: Element, norm: XYZ, curves: List[Curve], barTerminationsData: BarTerminationsData) -> Rebar: ...
    @overload
    ...
    def GetCenterlineCurves(self, adjustForSelfIntersection: bool, suppressHooksAndCranks: bool, suppressBendRadius: bool, multiplanarOption: MultiplanarOption, barPositionIndex: int) -> List[Curve]: ...
    def GetTransformedCenterlineCurves(self, adjustForSelfIntersection: bool, suppressHooksAndCranks: bool, suppressBendRadius: bool, multiplanarOption: MultiplanarOption, barPositionIndex: int) -> List[Curve]: ...
    ...
    def GetHookOrientation(self, end: int) -> RebarHookOrientation: ...
    def GetTerminationOrientation(self, end: int) -> RebarTerminationOrientation: ...
    def SetHookOrientation(self, end: int, terminationOrientation: RebarHookOrientation) -> None: ...
    def SetTerminationOrientation(self, end: int, terminationOrientation: RebarTerminationOrientation) -> None: ...
    def GetHookRotationAngle(self, end: int) -> float: ...
    def SetHookRotationAngle(self, rotationAngle: float, end: int) -> None: ...
...
class RebarShape(ElementType):
    ...
    @overload
    def Create(doc: Document, definition: RebarShapeDefinition, multiplanarDefinition: RebarShapeMultiplanarDefinition, style: RebarStyle, attachmentType: StirrupTieAttachmentType, startHookAngle: int, startHookOrientation: RebarHookOrientation, endHookAngle: int, endHookOrientation: RebarHookOrientation, higherEnd: int, terminationRotationAngleAtStart: float, terminationRotationAngleAtEnd: float, endTreatmentTypeIdAtStart: ElementId, endTreatmentTypeIdAtEnd: ElementId) -> RebarShape: ...
    @overload
    ...
    def GetDefaultHookAngle(self, end: int) -> int: ...
    def GetDefaultHookOrientation(self, end: int) -> RebarHookOrientation: ...
    ...
    def GetEndTreatmentTypeId(self, end: int) -> ElementId: ...
    def SetEndTreatmentTypeId(self, endTreatmentId: ElementId, end: int) -> None: ...
    def HasEndTreatment(self) -> bool: ...
    def RebarShapeMatchesCurvesAndTerminationsData(rebarShape: RebarShape, barType: RebarBarType, norm: XYZ, curves: List[Curve], rebarShapeTerminationsData: RebarShapeTerminationsData) -> bool: ...
...
class RebarBendData:
    @overload
    def __init__(self, barType: RebarBarType, style: RebarStyle, barTerminationsData: BarTerminationsData): ...
    @overload
    def __init__(self, barType: RebarBarType, hookType0: RebarHookType, hookType1: RebarHookType, style: RebarStyle, terminationOrientation0: RebarHookOrientation, terminationOrientation1: RebarHookOrientation): ...
    @overload
    def __init__(self): ...
    @property
    ...
    @property
    def TerminationOrientation0(self) -> RebarTerminationOrientation: ...
    @TerminationOrientation0.setter
    def TerminationOrientation0(self, terminationOrientation0: RebarTerminationOrientation) -> None: ...
    @property
    def TerminationOrientation1(self) -> RebarTerminationOrientation: ...
    @TerminationOrientation1.setter
    def TerminationOrientation1(self, terminationOrientation1: RebarTerminationOrientation) -> None: ...
    @property
    def HookBendRadius(self) -> float: ...
    @HookBendRadius.setter
    def HookBendRadius(self, hookBendRadius: float) -> None: ...
    @property
    def TerminationRotationAngle0(self) -> float: ...
    @TerminationRotationAngle0.setter
    def TerminationRotationAngle0(self, terminationRotationAngle0: float) -> None: ...
    @property
    def TerminationRotationAngle1(self) -> float: ...
    @TerminationRotationAngle1.setter
    def TerminationRotationAngle1(self, terminationRotationAngle1: float) -> None: ...
    @property
    def BarModelDiameter(self) -> float: ...
    @BarModelDiameter.setter
    ...
    @HookOrient0.setter
    def HookOrient0(self, terminationOrientation0: RebarHookOrientation) -> None: ...
    @property
    def HookOrient1(self) -> RebarHookOrientation: ...
    @HookOrient1.setter
    def HookOrient1(self, terminationOrientation1: RebarHookOrientation) -> None: ...
    @property
    def CrankOffsetLength0(self) -> float: ...
    @property
    def CrankOffsetLength1(self) -> float: ...
    @property
    def CrankStraightLength0(self) -> float: ...
    @property
    def CrankStraightLength1(self) -> float: ...
    @property
    def CrankAngledLength0(self) -> float: ...
    @property
    def CrankAngledLength1(self) -> float: ...
    @property
    def CrankRatio0(self) -> float: ...
    @property
    def CrankRatio1(self) -> float: ...
    @property
    def CrankLength0(self) -> float: ...
    @property
    def CrankLength1(self) -> float: ...
    @property
    def IsValidObject(self) -> bool: ...
    def Dispose(self) -> None: ...
...
class BarTerminationsData:
    ...
    @property
    def TerminationOrientationAtStart(self) -> RebarTerminationOrientation: ...
    @TerminationOrientationAtStart.setter
    def TerminationOrientationAtStart(self, terminationOrientationAtStart: RebarTerminationOrientation) -> None: ...
    @property
    def TerminationOrientationAtEnd(self) -> RebarTerminationOrientation: ...
    @TerminationOrientationAtEnd.setter
    def TerminationOrientationAtEnd(self, terminationOrientationAtEnd: RebarTerminationOrientation) -> None: ...
    @property
    def TerminationRotationAngleAtStart(self) -> float: ...
    @TerminationRotationAngleAtStart.setter
    def TerminationRotationAngleAtStart(self, terminationRotationAngleAtStart: float) -> None: ...
    @property
    def TerminationRotationAngleAtEnd(self) -> float: ...
    @TerminationRotationAngleAtEnd.setter
    def TerminationRotationAngleAtEnd(self, terminationRotationAngleAtEnd: float) -> None: ...
    @property
    def HookTypeIdAtStart(self) -> ElementId: ...
    @HookTypeIdAtStart.setter
    def HookTypeIdAtStart(self, hookTypeIdAtStart: ElementId) -> None: ...
    @property
    def HookTypeIdAtEnd(self) -> ElementId: ...
    @HookTypeIdAtEnd.setter
    def HookTypeIdAtEnd(self, hookTypeIdAtEnd: ElementId) -> None: ...
    @property
    def EndTreatmentTypeIdAtStart(self) -> ElementId: ...
    @EndTreatmentTypeIdAtStart.setter
    def EndTreatmentTypeIdAtStart(self, endTreatmentTypeIdAtStart: ElementId) -> None: ...
    @property
    def EndTreatmentTypeIdAtEnd(self) -> ElementId: ...
    @EndTreatmentTypeIdAtEnd.setter
    def EndTreatmentTypeIdAtEnd(self, endTreatmentTypeIdAtEnd: ElementId) -> None: ...
    @property
    def CrankTypeIdAtStart(self) -> ElementId: ...
    @CrankTypeIdAtStart.setter
    def CrankTypeIdAtStart(self, crankTypeIdAtStart: ElementId) -> None: ...
    @property
    def CrankTypeIdAtEnd(self) -> ElementId: ...
    @CrankTypeIdAtEnd.setter
    def CrankTypeIdAtEnd(self, crankTypeIdAtEnd: ElementId) -> None: ...
    @property
    def IsValidObject(self) -> bool: ...
...
class RebarShapeTerminationsData:
    ...
    def TerminationRotationAngleAtEnd(self, terminationRotationAngleAtEnd: float) -> None: ...
    @property
    def HookAngleAtStart(self) -> int: ...
    @HookAngleAtStart.setter
    def HookAngleAtStart(self, hookAngleAtStart: int) -> None: ...
    @property
    def HookAngleAtEnd(self) -> int: ...
    @HookAngleAtEnd.setter
    def HookAngleAtEnd(self, hookAngleAtEnd: int) -> None: ...
    @property
    def EndTreatmentTypeIdAtStart(self) -> ElementId: ...
    @EndTreatmentTypeIdAtStart.setter
    def EndTreatmentTypeIdAtStart(self, endTreatmentTypeIdAtStart: ElementId) -> None: ...
    ...
    def EndTreatmentTypeIdAtEnd(self, endTreatmentTypeIdAtEnd: ElementId) -> None: ...
    @property
    def HasCrankAtStart(self) -> bool: ...
    @HasCrankAtStart.setter
    def HasCrankAtStart(self, hasCrankAtStart: bool) -> None: ...
    @property
    def HasCrankAtEnd(self) -> bool: ...
    @HasCrankAtEnd.setter
    def HasCrankAtEnd(self, hasCrankAtEnd: bool) -> None: ...
    @property
    def IsValidObject(self) -> bool: ...
    def GetDocument(self) -> Document: ...
    def Dispose(self) -> None: ...
...
class BendingDetailCustomFieldProperties:
    ...
    @property
    def AngularDimensionsForCranksEnabled(self) -> bool: ...
    @AngularDimensionsForCranksEnabled.setter
    def AngularDimensionsForCranksEnabled(self, angularDimensionsForCranksEnabled: bool) -> None: ...
    @property
...
class FabricArea(Element):
    ...
    @property
    def DistributionOfWiresAtCover(self) -> WireDistributionDirection: ...
    @DistributionOfWiresAtCover.setter
    def DistributionOfWiresAtCover(self, distributionOfWiresAtCover: WireDistributionDirection) -> None: ...
    @property
...
class RebarUpdateCurvesData:
    ...
    def GetHostId(self) -> ElementId: ...
    def SetHookPlaneNormalForBarIdx(self, end: int, barPositionIndex: int, terminationPlaneNormal: XYZ) -> None: ...
...
class RebarContainer(Element):
    ...
    @overload
    def AppendItemFromCurves(self, style: RebarStyle, barType: RebarBarType, startHook: RebarHookType, endHook: RebarHookType, normal: XYZ, curves: List[Curve], startHookOrient: RebarTerminationOrientation, endHookOrient: RebarTerminationOrientation, useExistingShapeIfPossible: bool, createNewShape: bool) -> RebarContainerItem: ...
    @overload
    ...
    @overload
    def AppendItemFromCurvesAndShape(self, rebarShape: RebarShape, barType: RebarBarType, startHook: RebarHookType, endHook: RebarHookType, normal: XYZ, curves: List[Curve], startHookOrient: RebarTerminationOrientation, endHookOrient: RebarTerminationOrientation) -> RebarContainerItem: ...
    @overload
...
class RebarContainerItem:
    ...
    @overload
    def SetFromCurves(self, style: RebarStyle, barType: RebarBarType, startHook: RebarHookType, endHook: RebarHookType, norm: XYZ, curves: List[Curve], startHookOrient: RebarTerminationOrientation, endHookOrient: RebarTerminationOrientation, useExistingShapeIfPossible: bool, createNewShape: bool) -> None: ...
    @overload
    ...
    @overload
    def SetFromCurvesAndShape(self, rebarShape: RebarShape, barType: RebarBarType, startHook: RebarHookType, endHook: RebarHookType, norm: XYZ, curves: List[Curve], startHookOrient: RebarTerminationOrientation, endHookOrient: RebarTerminationOrientation) -> None: ...
    @overload
    ...
    def GetHookOrientation(self, end: int) -> RebarHookOrientation: ...
    def GetTerminationOrientation(self, end: int) -> RebarTerminationOrientation: ...
    def SetHookOrientation(self, end: int, hookOrientation: RebarHookOrientation) -> None: ...
...
class RebarCrankTypeUtils:
    ...
    def GetAllRebarCrankTypes(document: Document) -> List[ElementId]: ...
...
class ReinforcementSettings(Element):
    @property
    def NumberingMethod(self) -> ReinforcementNumberingMethod: ...
    @NumberingMethod.setter
    def NumberingMethod(self, numberingMethod: ReinforcementNumberingMethod) -> None: ...
    @property
...
class StructuralConnectionHandlerType(ElementType):
    ...
    def UpdateCustomConnectionType(structuralConnectionHandler: StructuralConnectionHandler, addReferences: List[Reference], removeReferences: List[Reference]) -> None: ...
...
class StructuralSettings(Element):
    ...
    @property
    def BoundarySetbackDisabledForSteelElements(self) -> bool: ...
    @BoundarySetbackDisabledForSteelElements.setter
    def BoundarySetbackDisabledForSteelElements(self, boundarySetbackDisabledForSteelElements: bool) -> None: ...
