...
class PyRevitAttachments:
    ...
    def GetAttachments() -> Iterable[PyRevitAttachment]: ...
...
class PyRevitClone:
    ...
    @overload
    def GetEngines(self, isNetCore: bool) -> List: ...
    @overload
    def GetEngine(self, revitYear: int, engineVer: PyRevitEngineVersion) -> PyRevitEngine: ...
    @overload
    def GetCPythonEngine(self, engineVer: PyRevitEngineVersion) -> PyRevitEngine: ...
    @overload
    def GetCPythonEngines(self) -> Iterable[PyRevitEngine]: ...
    @overload
    ...
    @overload
    def GetEngine(revitYear: int, clonePath: str, engineVer: PyRevitEngineVersion) -> PyRevitEngine: ...
    @overload
    def GetCPythonEngine(clonePath: str, engineVer: PyRevitEngineVersion) -> PyRevitEngine: ...
    @overload
    def GetCPythonEngines(clonePath: str) -> Iterable[PyRevitEngine]: ...
    @overload
    def GetEngines(clonePath: str) -> List: ...
    @overload
    def GetEngines(clonePath: str, isNetCore: bool) -> List: ...
    @overload
...
class PyRevitEngine:
    def __init__(self, id: str, engineVer: PyRevitEngineVersion, runtime: bool, enginePath: str, isNetCore: bool, assemblyName: str, kernelName: str, engineDescription: str, isDefault: bool): ...
    def ToString(self) -> str: ...
    @property
    def Id(self) -> str: ...
    @property
